...
const validate_cellname = (cellname) => {
    ...
    if (!second_char_int || second_char_int in [0, 1]) throw new Error("column 0 invalid for cellname, column 1 is reserved for header");
};
...
export const set_cell_value = async (cellname, value, opts) => {
    ...
    try {
        ...
        utils.sheet_add_aoa(first_worksheet, opts.append? [value]:[[value]], {origin: (opts.append? -1:cellname)});
